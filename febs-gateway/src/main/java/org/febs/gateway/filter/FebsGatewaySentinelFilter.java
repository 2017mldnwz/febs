...
import org.febs.gateway.fallback.FebsGatewayBlockFallbackProvider;
...
public class FebsGatewaySentinelFilter {
     ...
     *  我们通过ApiDefinition定义了一个API分组，名称为captcha，匹配的URL为/auth/captcha；然后通过GatewayFlowRule指定了限流的规则。其中网关限流规则 GatewayFlowRule 的字段解释如下：
    ...
    private void initGatewayRules() {
        ...
        rules.add(new GatewayFlowRule("captcha")  //要和上面的别名相对应，才可以准确的限制
